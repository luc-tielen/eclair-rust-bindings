...
extern "C" {
    ...
    pub fn eclair_add_fact(program: *mut Program, fact_type: u32, fact_data: *const Buffer);
    pub fn eclair_get_facts(program: *mut Program, fact_type: u32) -> *const Buffer;
    pub fn eclair_free_buffer(fact_data: *const Buffer);
